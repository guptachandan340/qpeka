...
public class Author extends User {
	...
	public Author(String _id, Name name,
			com.qpeka.db.Constants.GENDER gender, Date dob,
...
//		}
//		
//		return new Author(obj.getString(ID), Name.getNamefromDBObject((BasicDBObject)obj.get(NAME)), com.qpeka.db.Constants.GENDER.valueOf(obj.getString(GENDER)),
