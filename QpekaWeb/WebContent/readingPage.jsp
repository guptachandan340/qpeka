...
<!--     <link rel="stylesheet" href="bootstrap/css/readability/reset.css" type="text/css" media="screen, projection"> -->
<!--     <link rel="stylesheet" href="bootstrap/css/readability/typography.css" type="text/css" media="screen, projection"> -->
...
<!-- 						Since absinthe was legalized in the United States in 2007,  it has gone from forbidden fruit to virulent weed. Once smuggled from  Eastern Europe or procured from back-alley producers, absinthe is now  just another bottle on the bar. Yet mystique continues as marketing. -->
		...
		<div class="span2">
				<p class="muted">Ads</p>
				<p>
				<b><a href="#">New arrivals at FlipKart</a></b><br>
				<small class="text-success">www.flipkart.com</small><br>
				Find Book Reading Sites on Junglee.
				Compare Prices & Save Now!
				</p>
				<br>
				<p>
				<h5><a href="#">New arrivals at FlipKart</a></h5>
				<small class="text-success">www.flipkart.com</small><br>
				Find Book Reading Sites on Junglee.
				Compare Prices & Save Now!
				</p>
